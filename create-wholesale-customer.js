...
const SHOPIFY_STORE = process.env.SHOPIFY_STORE; // Will be: cronknutrients.myshopify.com
const SHOPIFY_ACCESS_TOKEN = process.env.SHOPIFY_ACCESS_TOKEN; // Your token
const SHOPIFY_API_VERSION = '2024-10';

// Enable CORS for your Shopify store
const corsHeaders = {
  'Access-Control-Allow-Origin': 'https://www.cronknutrients.com',
